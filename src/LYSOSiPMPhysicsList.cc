...
LYSOSiPMPhysicsList::LYSOSiPMPhysicsList():  G4VUserPhysicsList()
{
...
void LYSOSiPMPhysicsList::ConstructParticle()
{
...
void LYSOSiPMPhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void LYSOSiPMPhysicsList::ConstructLeptons()
{
  // leptons
  //  e+/-
...
void LYSOSiPMPhysicsList::ConstructMesons()
{
  //  mesons
  //    light mesons
...
void LYSOSiPMPhysicsList::ConstructBaryons()
{
  //  barions
...
void LYSOSiPMPhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructOp();
...
void LYSOSiPMPhysicsList::ConstructEM()
{
...
void LYSOSiPMPhysicsList::ConstructGeneral()
{
  G4PhysicsListHelper* ph = G4PhysicsListHelper::GetPhysicsListHelper();
...
void LYSOSiPMPhysicsList::AddStepMax()
{
...
void LYSOSiPMPhysicsList::SetCuts()
{
...
void LYSOSiPMPhysicsList::ConstructOp()
{
...
void LYSOSiPMPhysicsList::ConstructScintillation()
{
