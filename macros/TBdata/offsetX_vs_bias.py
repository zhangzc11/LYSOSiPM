...
leg_vs_bias.AddEntry(gr_x_upstream_vs_bias, "LYSO upstream, X", "p");
leg_vs_bias.AddEntry(gr_x_downstream_vs_bias, "LYSO downstream, X", "p");
leg_vs_bias.AddEntry(gr_xTW_upstream_vs_bias, "LYSO upstream, X, w/ TW corr", "p");
leg_vs_bias.AddEntry(gr_xTW_downstream_vs_bias, "LYSO downstream, X, w/ TW corr", "p");
