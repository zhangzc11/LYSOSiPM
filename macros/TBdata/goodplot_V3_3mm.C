...
void goodplot_V3_3mm(const std::string& inFileName, const std::string& ch1  = "16", float amp_low = 200.0, float amp_high = 850.0, float x_tile_low = 20.0, float x_tile_high = 30.0, float y_tile_low = 5.0, float y_tile_high = 12.0, float x_sipm_low = 23.0, float x_sipm_high = 27.0, float y_sipm_low = 7.0, float y_sipm_high = 10.0)
{
	//string ch1 = "15";
	string ch2 = "9";
