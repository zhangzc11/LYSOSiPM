...
x_upstream = [0.185162, 0.164589, 0.171371, 0.181001, 0.180476]
xTW_upstream = [0.158712, 0.151405, 0.148421, 0.142046, 0.164791]
...
leg_vs_bias.AddEntry(gr_y_upstream_vs_bias, "LYSO upstream, Y", "p");
leg_vs_bias.AddEntry(gr_y_downstream_vs_bias, "LYSO downstream, Y", "p");
leg_vs_bias.AddEntry(gr_yTW_upstream_vs_bias, "LYSO upstream, Y, w/ TW corr", "p");
leg_vs_bias.AddEntry(gr_yTW_downstream_vs_bias, "LYSO downstream, Y, w/ TW corr", "p");
leg_vs_bias.Draw()
