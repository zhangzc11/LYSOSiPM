...
void goodplot_V4(const std::string& inFileName, const std::string& ch1  = "16", float amp_low = 200.0, float amp_high = 850.0, float x_tile_low = 20.0, float x_tile_high = 30.0, float y_tile_low = 5.0, float y_tile_high = 12.0, float x_sipm_low = 23.0, float x_sipm_high = 27.0, float y_sipm_low = 7.0, float y_sipm_high = 10.0)
{
	//string ch1 = "15";
	string ch2 = "9";
	...
	mkdir(plotDir_ampbins.c_str(), S_IRWXU | S_IRWXG | S_IRWXO);
	mkdir(plotDir_effampbins.c_str(), S_IRWXU | S_IRWXG | S_IRWXO);
	...
	for(int ix = 1; ix<=9; ix++)
	{
		for(int iy=1;iy<=9;iy++)
		{
			...
			tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]>>h_deltaT_x"+std::to_string(ix)+"_y"+std::to_string(iy)).c_str(),(cut_noPos+" && x_dut[0]>"+std::to_string(thisX_low)+" && x_dut[0]<"+std::to_string(thisX_high) +" && y_dut[0]>"+std::to_string(thisY_low)+" && y_dut[0]<"+std::to_string(thisY_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2Dtimereso_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2Dtimereso_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2Dtimereso_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanT_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanT_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanT_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanAmp_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanAmp_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanAmp_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanRisetime_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanRisetime_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_2DtimemeanRisetime_ch"+ch1+".C").c_str());
	...
	for(int iamp = 1; iamp<=10; iamp++)
	{
		...
		tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]>>h_deltaT_amp"+std::to_string(iamp)).c_str(),(cut+" && amp["+ch1+"]>"+std::to_string(thisAmp_low)+" && amp["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_ampbins_timereso_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_ampbins_timereso_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_ampbins_timereso_ch"+ch1+".C").c_str());
	...
	float effamp_low = 200.0;
	float effamp_high = 1000.0;
	...
	for(int ieffamp = 1; ieffamp<=10; ieffamp++)
	{
		...
		tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]>>h_deltaT_effamp"+std::to_string(ieffamp)).c_str(),(cut+" && amp["+ch1+"]/baseline_RMS["+ch1+"]>"+std::to_string(thisAmp_low)+" && amp["+ch1+"]/baseline_RMS["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_effampbins_timereso_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_effampbins_timereso_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_effampbins_timereso_ch"+ch1+".C").c_str());
	...
	myC->SetGridx(1);
	// ch1
	TH2F * h2_beamSpotch1 = new TH2F("h2_beamSpotch1","h2_beamSpotch1",50,x_low, x_high,50,y_low, y_high);
	TH2F * h2_beamSpotch1Num = new TH2F("h2_beamSpotch1Num","h2_beamSpotch1Num",50,x_low, x_high,50,y_low,y_high);
	TH2F * h2_beamSpotch1NumNoCut = new TH2F("h2_beamSpotch1NumNoCut","h2_beamSpotch1Num",50,x_low, x_high,50,y_low,y_high);
	...
	h2_beamSpotch1->GetZaxis()->SetRangeUser(100.0, amp_high+50.0 );
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetimeVsXY_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetimeVsXY_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetimeVsXY_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_chi2VsXY_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_chi2VsXY_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_chi2VsXY_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_amplitude_scatter_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_amplitude_scatter_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_amplitude_scatter_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_baseline_RMS_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_baseline_RMS_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_baseline_RMS_ch"+ch1+".C").c_str());
	...
	sigmaTerr_noCor_sipm = tf1_gaus_sipm->GetParError(2);	
	...
	sigmaTerr_TWCor_sipm = tf1_gaus_sipm_TWcorr->GetParError(2);	
	...
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : x_dut[0]>>h2_risetime_vs_x").c_str(),cut_noPos.c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_profile_ch"+ch1+".C").c_str());

	h2_risetime_vs_x->Draw();
	p_risetime_vs_x->SetMarkerColor( 4 );
        p_risetime_vs_x->SetLineColor( 4 );
	p_risetime_vs_x->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamX_scatter_and_profile_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_profile_ch"+ch1+".C").c_str());

	h2_risetime_vs_y->Draw();
	p_risetime_vs_y->SetMarkerColor( 4 );
        p_risetime_vs_y->SetLineColor( 4 );
	p_risetime_vs_y->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_risetime_vs_beamY_scatter_and_profile_ch"+ch1+".C").c_str());
	...
	// impact point dependency of the deltaT_sipm, without TW correction, sipm, for visual effects
	myC->SetGridy(1);
	myC->SetGridx(1);
	...
	// impact point dependency of the deltaT_sipm, after TW correction, sipm, for visual effects
	...
	h2_deltaT_sipm_afterTW_vs_y->GetXaxis()->SetTitle("beam position Y [mm]");
	...
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : x_dut[0]>>h2_deltaT_vs_x_forCorr").c_str(),cut.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : x_dut[0]>>h2_deltaT_vs_x_forCorr").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_profile_ch"+ch1+".C").c_str());

	h2_deltaT_vs_x_forCorr->Draw();
	p_deltaT_vs_x_forCorr->SetMarkerColor( 4 );
        p_deltaT_vs_x_forCorr->SetLineColor( 4 );
	p_deltaT_vs_x_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+".C").c_str());
	...
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : y_dut[0]>>h2_deltaT_vs_y_forCorr").c_str(),cut.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : y_dut[0]>>h2_deltaT_vs_y_forCorr").c_str(), (cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_profile_ch"+ch1+".C").c_str());

	h2_deltaT_vs_y_forCorr->Draw();
	p_deltaT_vs_y_forCorr->SetMarkerColor( 4 );
        p_deltaT_vs_y_forCorr->SetLineColor( 4 );
	p_deltaT_vs_y_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+".C").c_str());
	...
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]:x_dut[0]>>h2_deltaT_afterTW_vs_x_forCorr").c_str(),cut_noPos.c_str());
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterTW_vs_x_forCorr").c_str(),cut.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterTW_vs_x_forCorr").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_profile_ch"+ch1+".C").c_str());
	...
	p_deltaT_afterTW_vs_x_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+".C").c_str());
	...
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterTW_vs_y_forCorr").c_str(),cut.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterTW_vs_y_forCorr").c_str(),(cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_profile_ch"+ch1+".C").c_str());
	...
	p_deltaT_afterTW_vs_y_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+".C").c_str());


	// impact point dependency of the deltaT_sipm, without TW correction, sipm, for real correction 
	myC->SetGridy(1);
	myC->SetGridx(1);
	TH2F * h2_deltaT_sipm_vs_x_forCorr = new TH2F("h2_deltaT_sipm_vs_x_forCorr","h2_deltaT_sipm_vs_x_forCorr", 72, x_low, x_high, 100, maxX_t_sipm-0.2, maxX_t_sipm+0.3);
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : x_dut[0]>>h2_deltaT_sipm_vs_x_forCorr").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : x_dut[0]>>h2_deltaT_sipm_vs_x_forCorr").c_str(),(cut_sipm+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	h2_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetTitle("beam position X [mm]");
	h2_deltaT_sipm_vs_x_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_vs_x_forCorr->SetTitle("");
	h2_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_vs_x_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_vs_x_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_vs_x_forCorr->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_vs_x_forCorr = h2_deltaT_sipm_vs_x_forCorr->ProfileX(); 
	p_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetTitle("beam position X [mm]");
	p_deltaT_sipm_vs_x_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_vs_x_forCorr->SetTitle("");
	
	p_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_vs_x_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_vs_x_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	p_deltaT_sipm_vs_x_forCorr->GetYaxis()->SetRangeUser(maxX_t_sipm-0.2, maxX_t_sipm+0.3);
       	p_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
        p_deltaT_sipm_vs_x_forCorr->SetMarkerStyle( 20 );
        p_deltaT_sipm_vs_x_forCorr->SetMarkerColor( 1 );
        p_deltaT_sipm_vs_x_forCorr->SetLineColor( 1 );
	p_deltaT_sipm_vs_x_forCorr->Draw();

	TF1 * tf1_xyonly_pol4_forCorr_sipm_x = new TF1("tf1_xyonly_pol4_forCorr_sipm_x","pol4", x_sipm_low-1, x_sipm_high+1.0);
	p_deltaT_sipm_vs_x_forCorr->Fit("tf1_xyonly_pol4_forCorr_sipm_x","","",x_sipm_low_fit, x_sipm_high_fit);
	x_cor_sipm_xyonly_p0 = tf1_xyonly_pol4_forCorr_sipm_x->GetParameter(0);
	x_cor_sipm_xyonly_p1 = tf1_xyonly_pol4_forCorr_sipm_x->GetParameter(1);
	x_cor_sipm_xyonly_p2 = tf1_xyonly_pol4_forCorr_sipm_x->GetParameter(2);
	x_cor_sipm_xyonly_p3 = tf1_xyonly_pol4_forCorr_sipm_x->GetParameter(3);
	x_cor_sipm_xyonly_p4 = tf1_xyonly_pol4_forCorr_sipm_x->GetParameter(4);
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_vs_x_forCorr->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
	h2_deltaT_sipm_vs_x_forCorr->Draw();
	p_deltaT_sipm_vs_x_forCorr->SetMarkerColor( 4 );
        p_deltaT_sipm_vs_x_forCorr->SetLineColor( 4 );
	p_deltaT_sipm_vs_x_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
	
	TH2F * h2_deltaT_sipm_vs_y_forCorr = new TH2F("h2_deltaT_sipm_vs_y_forCorr","h2_deltaT_sipm_vs_y_forCorr", 72, y_low, y_high, 100, maxX_t_sipm-0.2, maxX_t_sipm+0.3);
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : y_dut[0]>>h2_deltaT_sipm_vs_y_forCorr").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] : y_dut[0]>>h2_deltaT_sipm_vs_y_forCorr").c_str(), (cut_sipm+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	h2_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetTitle("beam position Y [mm]");
	h2_deltaT_sipm_vs_y_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_vs_y_forCorr->SetTitle("");
	h2_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_vs_y_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_vs_y_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_vs_y_forCorr->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_vs_y_forCorr = h2_deltaT_sipm_vs_y_forCorr->ProfileX(); //new ("p_deltaT_sipm_vs_y_forCorr","p_deltaT_sipm_vs_y_forCorr",72, y_low, y_high);
	p_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetTitle("beam position Y [mm]");
	p_deltaT_sipm_vs_y_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_vs_y_forCorr->SetTitle("");
	
	p_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_vs_y_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_vs_y_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	p_deltaT_sipm_vs_y_forCorr->GetYaxis()->SetRangeUser(maxX_t_sipm-0.2, maxX_t_sipm+0.3);
       	p_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
        p_deltaT_sipm_vs_y_forCorr->SetMarkerStyle( 20 );
        p_deltaT_sipm_vs_y_forCorr->SetMarkerColor( 1 );
        p_deltaT_sipm_vs_y_forCorr->SetLineColor( 1 );
	p_deltaT_sipm_vs_y_forCorr->Draw();

	TF1 * tf1_xyonly_pol4_forCorr_sipm_y = new TF1("tf1_xyonly_pol4_forCorr_sipm_y","pol4", y_sipm_low-1, y_sipm_high+1.0);
	p_deltaT_sipm_vs_y_forCorr->Fit("tf1_xyonly_pol4_forCorr_sipm_y","","",y_sipm_low_fit, y_sipm_high_fit);
	y_cor_sipm_xyonly_p0 = tf1_xyonly_pol4_forCorr_sipm_y->GetParameter(0);
	y_cor_sipm_xyonly_p1 = tf1_xyonly_pol4_forCorr_sipm_y->GetParameter(1);
	y_cor_sipm_xyonly_p2 = tf1_xyonly_pol4_forCorr_sipm_y->GetParameter(2);
	y_cor_sipm_xyonly_p3 = tf1_xyonly_pol4_forCorr_sipm_y->GetParameter(3);
	y_cor_sipm_xyonly_p4 = tf1_xyonly_pol4_forCorr_sipm_y->GetParameter(4);
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_vs_y_forCorr->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
	h2_deltaT_sipm_vs_y_forCorr->Draw();
	p_deltaT_sipm_vs_y_forCorr->SetMarkerColor( 4 );
        p_deltaT_sipm_vs_y_forCorr->SetLineColor( 4 );
	p_deltaT_sipm_vs_y_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
	
	// impact point dependency of the deltaT_sipm, after TW correction, sipm, forreal correction 

	myC->SetGridy(1);
	myC->SetGridx(1);
	TH2F * h2_deltaT_sipm_afterTW_vs_x_forCorr = new TH2F("h2_deltaT_sipm_afterTW_vs_x_forCorr","h2_deltaT_sipm_afterTW_vs_x_forCorr", 72, x_low, x_high, 100, maxX_t_sipm_TWcorr-0.2, maxX_t_sipm_TWcorr+0.3);
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]:x_dut[0]>>h2_deltaT_sipm_afterTW_vs_x_forCorr").c_str(),cut_sipm.c_str());
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_sipm_afterTW_vs_x_forCorr").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_sipm_afterTW_vs_x_forCorr").c_str(),(cut_sipm+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	h2_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetTitle("beam position X [mm]");
	h2_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_afterTW_vs_x_forCorr->SetTitle("");
	h2_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_afterTW_vs_x_forCorr->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_afterTW_vs_x_forCorr = h2_deltaT_sipm_afterTW_vs_x_forCorr->ProfileX(); //new ("p_deltaT_sipm_afterTW_vs_x_forCorr","p_deltaT_sipm_afterTW_vs_x_forCorr",72, x_low, x_high);
	p_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetTitle("beam position X [mm]");
	p_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_afterTW_vs_x_forCorr->SetTitle("");
	
	p_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	//p_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetRangeUser(maxX_t_sipm-0.2, maxX_t_sipm+0.3);
       	p_deltaT_sipm_afterTW_vs_x_forCorr->GetYaxis()->SetRangeUser(maxX_t_sipm_TWcorr-0.2, maxX_t_sipm_TWcorr+0.3);
       	p_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
        p_deltaT_sipm_afterTW_vs_x_forCorr->SetMarkerStyle( 20 );
        p_deltaT_sipm_afterTW_vs_x_forCorr->SetMarkerColor( 1 );
        p_deltaT_sipm_afterTW_vs_x_forCorr->SetLineColor( 1 );
	p_deltaT_sipm_afterTW_vs_x_forCorr->Draw();

	TF1 * tf1_pol4_forCorr_sipm_x = new TF1("tf1_pol4_forCorr_sipm_x","pol4", x_sipm_low-1, x_sipm_high+1.0);
	p_deltaT_sipm_afterTW_vs_x_forCorr->Fit("tf1_pol4_forCorr_sipm_x","","",x_sipm_low_fit, x_sipm_high_fit);
	x_cor_sipm_p0 = tf1_pol4_forCorr_sipm_x->GetParameter(0);
	x_cor_sipm_p1 = tf1_pol4_forCorr_sipm_x->GetParameter(1);
	x_cor_sipm_p2 = tf1_pol4_forCorr_sipm_x->GetParameter(2);
	x_cor_sipm_p3 = tf1_pol4_forCorr_sipm_x->GetParameter(3);
	x_cor_sipm_p4 = tf1_pol4_forCorr_sipm_x->GetParameter(4);
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_afterTW_vs_x_forCorr->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
	h2_deltaT_sipm_afterTW_vs_x_forCorr->Draw();
	p_deltaT_sipm_afterTW_vs_x_forCorr->SetMarkerColor( 4 );
        p_deltaT_sipm_afterTW_vs_x_forCorr->SetLineColor( 4 );
	p_deltaT_sipm_afterTW_vs_x_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamX_forCorr_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
	

	TH2F * h2_deltaT_sipm_afterTW_vs_y_forCorr = new TH2F("h2_deltaT_sipm_afterTW_vs_y_forCorr","h2_deltaT_sipm_afterTW_vs_y_forCorr", 72, y_low, y_high, 100, maxX_t_sipm_TWcorr-0.2, maxX_t_sipm_TWcorr+0.3);
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_sipm_afterTW_vs_y_forCorr").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_sipm_afterTW_vs_y_forCorr").c_str(),(cut_sipm+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	h2_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetTitle("beam position Y [mm]");
	h2_deltaT_sipm_afterTW_vs_y_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_afterTW_vs_y_forCorr->SetTitle("");
	h2_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_afterTW_vs_y_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_afterTW_vs_y_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_afterTW_vs_y_forCorr->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_afterTW_vs_y_forCorr = h2_deltaT_sipm_afterTW_vs_y_forCorr->ProfileX(); //new ("p_deltaT_sipm_afterTW_vs_y_forCorr","p_deltaT_sipm_afterTW_vs_y_forCorr",72, y_low, y_high);
	p_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetTitle("beam position Y [mm]");
	p_deltaT_sipm_afterTW_vs_y_forCorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_afterTW_vs_y_forCorr->SetTitle("");
	
	p_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_afterTW_vs_y_forCorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_afterTW_vs_y_forCorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	p_deltaT_sipm_afterTW_vs_y_forCorr->GetYaxis()->SetRangeUser(maxX_t_sipm_TWcorr-0.2, maxX_t_sipm_TWcorr+0.3);
       	p_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
        p_deltaT_sipm_afterTW_vs_y_forCorr->SetMarkerStyle( 20 );
        p_deltaT_sipm_afterTW_vs_y_forCorr->SetMarkerColor( 1 );
        p_deltaT_sipm_afterTW_vs_y_forCorr->SetLineColor( 1 );
	p_deltaT_sipm_afterTW_vs_y_forCorr->Draw();

	TF1 * tf1_pol4_forCorr_sipm_y = new TF1("tf1_pol4_forCorr_sipm_y","pol4", y_sipm_low-1, y_sipm_high+1.0);
	p_deltaT_sipm_afterTW_vs_y_forCorr->Fit("tf1_pol4_forCorr_sipm_y","","",y_sipm_low_fit, y_sipm_high_fit);
	y_cor_sipm_p0 = tf1_pol4_forCorr_sipm_y->GetParameter(0);
	y_cor_sipm_p1 = tf1_pol4_forCorr_sipm_y->GetParameter(1);
	y_cor_sipm_p2 = tf1_pol4_forCorr_sipm_y->GetParameter(2);
	y_cor_sipm_p3 = tf1_pol4_forCorr_sipm_y->GetParameter(3);
	y_cor_sipm_p4 = tf1_pol4_forCorr_sipm_y->GetParameter(4);
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_afterTW_vs_y_forCorr->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
	h2_deltaT_sipm_afterTW_vs_y_forCorr->Draw();
	p_deltaT_sipm_afterTW_vs_y_forCorr->SetMarkerColor( 4 );
        p_deltaT_sipm_afterTW_vs_y_forCorr->SetLineColor( 4 );
	p_deltaT_sipm_afterTW_vs_y_forCorr->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTW_vs_beamY_forCorr_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
...
+")>>h_deltaT_sipm_XYcorr").c_str(), cut_sipm.c_str());
	...
	sigmaTerr_XYCor_sipm = tf1_gaus_sipm_XYcorr->GetParError(2);	
...
+"):amp["+ch1+"]>>h2_deltaT_vs_amp_afterXYcorr").c_str(),cut.c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_profile_ch"+ch1+".C").c_str());


	//amplitude dependency of the deltaT_sipm, aftet XY corr
	myC->SetGridy(1);
	myC->SetGridx(1);
	TH2F * h2_deltaT_sipm_vs_amp_afterXYcorr = new TH2F("h2_deltaT_sipm_vs_amp_afterXYcorr","h2_deltaT_sipm_vs_amp_afterXYcorr", 100, amp_low, amp_high, 100, maxX_t_sipm_XYcorr-0.6, maxX_t_sipm_XYcorr+0.6);
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]:amp["+ch1+"]>>h2_deltaT_sipm_vs_amp_afterXYcorr").c_str(),cut_sipm.c_str());

        tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- (" + std::to_string(x_cor_sipm_xyonly_p0)+" + "
+std::to_string(x_cor_sipm_xyonly_p1)+"*x_dut[0] + "+std::to_string(x_cor_sipm_xyonly_p2)+"*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_sipm_xyonly_p3)+"*x_dut[0]*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_sipm_xyonly_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0]+"
+std::to_string(y_cor_sipm_xyonly_p0)+" + "
+std::to_string(y_cor_sipm_xyonly_p1)+"*y_dut[0] + "+std::to_string(y_cor_sipm_xyonly_p2)+"*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_sipm_xyonly_p3)+"*y_dut[0]*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_sipm_xyonly_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0]"
+"):amp["+ch1+"]>>h2_deltaT_sipm_vs_amp_afterXYcorr").c_str(),cut_sipm.c_str());



	h2_deltaT_sipm_vs_amp_afterXYcorr->GetXaxis()->SetTitle("amplitude [mV]");
	h2_deltaT_sipm_vs_amp_afterXYcorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_vs_amp_afterXYcorr->SetTitle("");
	h2_deltaT_sipm_vs_amp_afterXYcorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_vs_amp_afterXYcorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_vs_amp_afterXYcorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_vs_amp_afterXYcorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_vs_amp_afterXYcorr->Draw();
	
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_vs_amp_afterXYcorr = h2_deltaT_sipm_vs_amp_afterXYcorr->ProfileX(); 
	p_deltaT_sipm_vs_amp_afterXYcorr->GetXaxis()->SetTitle("amplitude [mV]");
	p_deltaT_sipm_vs_amp_afterXYcorr->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_vs_amp_afterXYcorr->SetTitle("");
	
	p_deltaT_sipm_vs_amp_afterXYcorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_vs_amp_afterXYcorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_vs_amp_afterXYcorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_vs_amp_afterXYcorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	p_deltaT_sipm_vs_amp_afterXYcorr->GetYaxis()->SetRangeUser(maxX_t_sipm_XYcorr-0.2, maxX_t_sipm_XYcorr+0.3);
       	p_deltaT_sipm_vs_amp_afterXYcorr->GetXaxis()->SetRangeUser(amp_low, amp_high);
        p_deltaT_sipm_vs_amp_afterXYcorr->SetMarkerStyle( 20 );
        p_deltaT_sipm_vs_amp_afterXYcorr->SetMarkerColor( 1 );
        p_deltaT_sipm_vs_amp_afterXYcorr->SetLineColor( 1 );
	p_deltaT_sipm_vs_amp_afterXYcorr->Draw();


	TF1 * tf1_pol1_afterXYcorr_amp_sipm = new TF1("tf1_pol1_afterXYcorr_amp_sipm","pol1", amp_low, amp_high);
	p_deltaT_sipm_vs_amp_afterXYcorr->Fit("tf1_pol1_afterXYcorr_amp_sipm","","",amp_low_fit, amp_high_fit);
	float amp_cor_afterXYcorr_sipm_p0 = tf1_pol1_afterXYcorr_amp_sipm->GetParameter(0);
	float amp_cor_afterXYcorr_sipm_p1 = tf1_pol1_afterXYcorr_amp_sipm->GetParameter(1);

	cout<<"p0: "<<amp_cor_afterXYcorr_sipm_p0<<" ;  p1: "<<amp_cor_afterXYcorr_sipm_p1<<endl;

	gPad->Modified();
	gPad->Update();
	
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_vs_amp_afterXYcorr_profile_ch"+ch1+"_sipm.C").c_str());
...
+")>>h_deltaT_sipm_TWXYcorr").c_str(), cut_sipm.c_str());	
	...
	sigmaTerr_TWXYCor_sipm = tf1_gaus_sipm_TWXYcorr->GetParError(2);	
	...
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_afterXYcorr_p0)+" + "+std::to_string(amp_cor_afterXYcorr_p1)+"*amp["+ch1+"] + "
...
+")>>h_deltaT_XYTWcorr").c_str(), cut.c_str());	
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_XY_then_TWcorr_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_XY_then_TWcorr_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_XY_then_TWcorr_ch"+ch1+".C").c_str());


	//time resolution with impact point + TW correction, sipm
	myC->SetGridy(0);
	myC->SetGridx(0);
	
	TH1F * h_deltaT_sipm_XYTWcorr = new TH1F("h_deltaT_sipm_XYTWcorr","h_deltaT_sipm_XYTWcorr",100000, -1000.0, 1000.0);
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_afterXYcorr_sipm_p0)+" + "+std::to_string(amp_cor_afterXYcorr_sipm_p1)+"*amp["+ch1+"] + "
+std::to_string(x_cor_sipm_xyonly_p0)+ "+" +std::to_string(x_cor_sipm_xyonly_p1)+"*x_dut[0] + "+std::to_string(x_cor_sipm_xyonly_p2)+"*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_sipm_xyonly_p3)+"*x_dut[0]*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_sipm_xyonly_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0] + "
+std::to_string(y_cor_sipm_xyonly_p0) + " + " + std::to_string(y_cor_sipm_xyonly_p1)+"*y_dut[0] + "+std::to_string(y_cor_sipm_xyonly_p2)+"*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_sipm_xyonly_p3)+"*y_dut[0]*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_sipm_xyonly_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0] "
+")>>h_deltaT_sipm_XYTWcorr").c_str(), cut_sipm.c_str());	

	h_deltaT_sipm_XYTWcorr->SetTitle("");
	h_deltaT_sipm_XYTWcorr->SetMarkerStyle( 20 );
	h_deltaT_sipm_XYTWcorr->SetMarkerColor( 1 );
	h_deltaT_sipm_XYTWcorr->SetLineColor( 1 );
	h_deltaT_sipm_XYTWcorr->GetXaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h_deltaT_sipm_XYTWcorr->GetYaxis()->SetTitle("Events");
	h_deltaT_sipm_XYTWcorr->SetTitle("");
	h_deltaT_sipm_XYTWcorr->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h_deltaT_sipm_XYTWcorr->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h_deltaT_sipm_XYTWcorr->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h_deltaT_sipm_XYTWcorr->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	float maxY_t_sipm_XYTWcorr = h_deltaT_sipm_XYTWcorr->GetMaximum();
	float maxX_t_sipm_XYTWcorr = h_deltaT_sipm_XYTWcorr->GetBinCenter(h_deltaT_sipm_XYTWcorr->GetMaximumBin());
       	h_deltaT_sipm_XYTWcorr->GetXaxis()->SetRangeUser(maxX_t_sipm_XYTWcorr-0.6, maxX_t_sipm_XYTWcorr+0.6);
        h_deltaT_sipm_XYTWcorr->Draw("E");

	float highDeltaT_sipm_XYTWcorr=maxX_t_sipm_XYTWcorr + fit_range_right;//h_deltaT_sipm_XYTWcorr->GetBinCenter(h_deltaT_sipm_XYTWcorr->FindLastBinAbove(int(0.3*maxY_t_sipm)));
	float lowDeltaT_sipm_XYTWcorr=maxX_t_sipm_XYTWcorr - fit_range_left;//h_deltaT_sipm_XYTWcorr->GetBinCenter(h_deltaT_sipm_XYTWcorr->FindFirstBinAbove(int(0.1*maxY_t_sipm)));
	//if(highDeltaT_sipm_XYTWcorr - maxX_t_sipm_XYTWcorr > 2.0*(maxX_t_sipm_XYTWcorr-lowDeltaT_sipm_XYTWcorr)) highDeltaT_sipm_XYTWcorr = maxX_t_sipm_XYTWcorr + (maxX_t_sipm_XYTWcorr - lowDeltaT_sipm_XYTWcorr);
	TF1 * tf1_gaus_sipm_XYTWcorr = new TF1("tf1_gaus_sipm_XYTWcorr","gaus", maxX_t_sipm_XYTWcorr - 1.0, maxX_t_sipm_XYTWcorr + 1.0);
	tf1_gaus_sipm_XYTWcorr->SetParameter(1, h_deltaT_sipm_XYTWcorr->GetMean());
	h_deltaT_sipm_XYTWcorr->Fit("tf1_gaus_sipm_XYTWcorr","","",lowDeltaT_sipm_XYTWcorr, highDeltaT_sipm_XYTWcorr);

	sigmaT_XYTWCor_sipm = tf1_gaus_sipm_XYTWcorr->GetParameter(2);	
	sigmaTerr_XYTWCor_sipm = tf1_gaus_sipm_XYTWcorr->GetParError(2);	
	if(sigmaT_XYTWCor_sipm <  sigmaT_best_sipm) sigmaT_best_sipm = sigmaT_XYTWCor_sipm;

	gPad->Modified();
	gPad->Update();

	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_XY_then_TWcorr_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_XY_then_TWcorr_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_XY_then_TWcorr_ch"+ch1+"_sipm.C").c_str());
	...
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]:x_dut[0]>>h2_deltaT_afterXY_vs_x").c_str(),cut_noPos.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterXY_vs_x").c_str(),cut_noPos.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterXY_vs_x").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
...
+") : x_dut[0]>>h2_deltaT_afterXY_vs_x").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_profile_ch"+ch1+".C").c_str());

	h2_deltaT_afterXY_vs_x->Draw();
	p_deltaT_afterXY_vs_x->SetMarkerColor( 4 );
        p_deltaT_afterXY_vs_x->SetLineColor( 4 );
	p_deltaT_afterXY_vs_x->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_scatter_and_profile_ch"+ch1+".C").c_str());
	...
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterXY_vs_y").c_str(),cut_noPos.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterXY_vs_y").c_str(),(cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
...
+") : y_dut[0]>>h2_deltaT_afterXY_vs_y").c_str(),(cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_profile_ch"+ch1+".C").c_str());

	h2_deltaT_afterXY_vs_y->Draw();
	p_deltaT_afterXY_vs_y->SetMarkerColor( 4 );
        p_deltaT_afterXY_vs_y->SetLineColor( 4 );
	p_deltaT_afterXY_vs_y->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_scatter_and_profile_ch"+ch1+".C").c_str());



	
	// impact point dependency of the deltaT_sipm, after XY correction, sipm, for visual effects

	myC->SetGridy(1);
	myC->SetGridx(1);
	TH2F * h2_deltaT_sipm_afterXY_vs_x = new TH2F("h2_deltaT_sipm_afterXY_vs_x","h2_deltaT_sipm_afterXY_vs_x", 72, x_low, x_high, 100, maxX_t_sipm_XYcorr-0.2, maxX_t_sipm_XYcorr+0.3);
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]:x_dut[0]>>h2_deltaT_sipm_afterXY_vs_x").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_sipm_afterXY_vs_x").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_sipm_afterXY_vs_x").c_str(),(cut_sipm+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
...
+std::to_string(y_cor_sipm_xyonly_p0)+" + "
+std::to_string(y_cor_sipm_xyonly_p1)+"*y_dut[0] + "+std::to_string(y_cor_sipm_xyonly_p2)+"*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_sipm_xyonly_p3)+"*y_dut[0]*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_sipm_xyonly_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0]"
+") : x_dut[0]>>h2_deltaT_sipm_afterXY_vs_x").c_str(),(cut_sipm+" && y_dut[0]>"+std::to_string(y_sipm_low)+" &&y_dut[0]<"+std::to_string(y_sipm_high)).c_str());


	h2_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetTitle("beam position X [mm]");
	h2_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_afterXY_vs_x->SetTitle("");
	h2_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_afterXY_vs_x->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_afterXY_vs_x = h2_deltaT_sipm_afterXY_vs_x->ProfileX(); //new ("p_deltaT_sipm_afterXY_vs_x","p_deltaT_sipm_afterXY_vs_x",72, x_low, x_high);
	p_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetTitle("beam position X [mm]");
	p_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_afterXY_vs_x->SetTitle("");
	
	p_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	//p_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetRangeUser(maxX_t_sipm-0.2, maxX_t_sipm+0.3);
       	p_deltaT_sipm_afterXY_vs_x->GetYaxis()->SetRangeUser(maxX_t_sipm_XYcorr-0.2, maxX_t_sipm_XYcorr+0.3);
       	p_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
        p_deltaT_sipm_afterXY_vs_x->SetMarkerStyle( 20 );
        p_deltaT_sipm_afterXY_vs_x->SetMarkerColor( 1 );
        p_deltaT_sipm_afterXY_vs_x->SetLineColor( 1 );
	p_deltaT_sipm_afterXY_vs_x->Draw();

	TF1 * tf1_pol4_afterXY_sipm_x = new TF1("tf1_pol4_afterXY_sipm_x","pol4", x_sipm_low-1, x_sipm_high+1.0);
	p_deltaT_sipm_afterXY_vs_x->Fit("tf1_pol4_afterXY_sipm_x","","",x_sipm_low_fit, x_sipm_high_fit);

	gPad->Modified();
	gPad->Update();
	
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_afterXY_vs_x->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
	h2_deltaT_sipm_afterXY_vs_x->Draw();
	p_deltaT_sipm_afterXY_vs_x->SetMarkerColor( 4 );
        p_deltaT_sipm_afterXY_vs_x->SetLineColor( 4 );
	p_deltaT_sipm_afterXY_vs_x->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamX_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
	

	TH2F * h2_deltaT_sipm_afterXY_vs_y = new TH2F("h2_deltaT_sipm_afterXY_vs_y","h2_deltaT_sipm_afterXY_vs_y", 72, y_low, y_high, 100, maxX_t_sipm_XYcorr-0.2, maxX_t_sipm_XYcorr+0.3);
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_sipm_afterXY_vs_y").c_str(),cut_sipm.c_str());

	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- (" + std::to_string(x_cor_sipm_xyonly_p0)+" + "
+std::to_string(x_cor_sipm_xyonly_p1)+"*x_dut[0] + "+std::to_string(x_cor_sipm_xyonly_p2)+"*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_sipm_xyonly_p3)+"*x_dut[0]*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_sipm_xyonly_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0]+"
+std::to_string(y_cor_sipm_xyonly_p0)+" + "
+std::to_string(y_cor_sipm_xyonly_p1)+"*y_dut[0] + "+std::to_string(y_cor_sipm_xyonly_p2)+"*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_sipm_xyonly_p3)+"*y_dut[0]*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_sipm_xyonly_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0]"
+") : y_dut[0]>>h2_deltaT_sipm_afterXY_vs_y").c_str(),(cut_sipm+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());



	h2_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetTitle("beam position Y [mm]");
	h2_deltaT_sipm_afterXY_vs_y->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_afterXY_vs_y->SetTitle("");
	h2_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_afterXY_vs_y->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_afterXY_vs_y->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_afterXY_vs_y->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_afterXY_vs_y = h2_deltaT_sipm_afterXY_vs_y->ProfileX(); //new ("p_deltaT_sipm_afterXY_vs_y","p_deltaT_sipm_afterXY_vs_y",72, y_low, y_high);
	p_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetTitle("beam position Y [mm]");
	p_deltaT_sipm_afterXY_vs_y->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_afterXY_vs_y->SetTitle("");
	
	p_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_afterXY_vs_y->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_afterXY_vs_y->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	p_deltaT_sipm_afterXY_vs_y->GetYaxis()->SetRangeUser(maxX_t_sipm_XYcorr-0.2, maxX_t_sipm_XYcorr+0.3);
       	p_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
        p_deltaT_sipm_afterXY_vs_y->SetMarkerStyle( 20 );
        p_deltaT_sipm_afterXY_vs_y->SetMarkerColor( 1 );
        p_deltaT_sipm_afterXY_vs_y->SetLineColor( 1 );
	p_deltaT_sipm_afterXY_vs_y->Draw();

	TF1 * tf1_pol4_afterXY_sipm_y = new TF1("tf1_pol4_afterXY_sipm_y","pol4", y_sipm_low-1, y_sipm_high+1.0);
	p_deltaT_sipm_afterXY_vs_y->Fit("tf1_pol4_afterXY_sipm_y","","",y_sipm_low_fit, y_sipm_high_fit);
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_afterXY_vs_y->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
	h2_deltaT_sipm_afterXY_vs_y->Draw();
	p_deltaT_sipm_afterXY_vs_y->SetMarkerColor( 4 );
        p_deltaT_sipm_afterXY_vs_y->SetLineColor( 4 );
	p_deltaT_sipm_afterXY_vs_y->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterXY_vs_beamY_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
	...
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]:x_dut[0]>>h2_deltaT_afterTWXY_vs_x").c_str(),cut_noPos.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterTWXY_vs_x").c_str(),cut_noPos.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_afterTWXY_vs_x").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_p0)+" + "+std::to_string(amp_cor_p1)+"*amp["+ch1+"] + "
+std::to_string(x_cor_p0)+ "+" +std::to_string(x_cor_p1)+"*x_dut[0] + "+std::to_string(x_cor_p2)+"*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_p3)+"*x_dut[0]*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0] + "
+std::to_string(y_cor_p0) + " + " + std::to_string(y_cor_p1)+"*y_dut[0] + "+std::to_string(y_cor_p2)+"*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_p3)+"*y_dut[0]*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0] "
+") : x_dut[0]>>h2_deltaT_afterTWXY_vs_x").c_str(),(cut_noPos+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_profile_ch"+ch1+".C").c_str());

	h2_deltaT_afterTWXY_vs_x->Draw();
	p_deltaT_afterTWXY_vs_x->SetMarkerColor( 4 );
        p_deltaT_afterTWXY_vs_x->SetLineColor( 4 );
	p_deltaT_afterTWXY_vs_x->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_scatter_and_profile_ch"+ch1+".C").c_str());
	...
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterTWXY_vs_y").c_str(),cut_noPos.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_afterTWXY_vs_y").c_str(),(cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_p0)+" + "+std::to_string(amp_cor_p1)+"*amp["+ch1+"] + "
+std::to_string(x_cor_p0)+ "+" +std::to_string(x_cor_p1)+"*x_dut[0] + "+std::to_string(x_cor_p2)+"*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_p3)+"*x_dut[0]*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0] + "
+std::to_string(y_cor_p0) + " + " + std::to_string(y_cor_p1)+"*y_dut[0] + "+std::to_string(y_cor_p2)+"*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_p3)+"*y_dut[0]*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0] "
+") : y_dut[0]>>h2_deltaT_afterTWXY_vs_y").c_str(),(cut_noPos+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str()); 
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_profile_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_profile_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_profile_ch"+ch1+".C").c_str());

	h2_deltaT_afterTWXY_vs_y->Draw();
	p_deltaT_afterTWXY_vs_y->SetMarkerColor( 4 );
        p_deltaT_afterTWXY_vs_y->SetLineColor( 4 );
	p_deltaT_afterTWXY_vs_y->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_scatter_and_profile_ch"+ch1+".pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_scatter_and_profile_ch"+ch1+".png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_scatter_and_profile_ch"+ch1+".C").c_str());



	
	// impact point dependency of the deltaT_sipm, after TWXY correction, sipm, for visual effects

	myC->SetGridy(1);
	myC->SetGridx(1);
	TH2F * h2_deltaT_sipm_afterTWXY_vs_x = new TH2F("h2_deltaT_sipm_afterTWXY_vs_x","h2_deltaT_sipm_afterTWXY_vs_x", 72, x_low, x_high, 100, maxX_t_sipm_TWXYcorr-0.2, maxX_t_sipm_TWXYcorr+0.3);
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]:x_dut[0]>>h2_deltaT_sipm_afterTWXY_vs_x").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_sipm_afterTWXY_vs_x").c_str(),cut_sipm.c_str());
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+ std::to_string(amp_cor_p0) + " + " + std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : x_dut[0]>>h2_deltaT_sipm_afterTWXY_vs_x").c_str(),(cut_sipm+" && y_dut[0]>"+std::to_string(y_sipm_low)+" && y_dut[0]<"+std::to_string(y_sipm_high)).c_str());
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_sipm_p0)+" + "+std::to_string(amp_cor_sipm_p1)+"*amp["+ch1+"] + "
+std::to_string(x_cor_sipm_p0)+ "+" +std::to_string(x_cor_sipm_p1)+"*x_dut[0] + "+std::to_string(x_cor_sipm_p2)+"*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_sipm_p3)+"*x_dut[0]*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_sipm_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0] + "
+std::to_string(y_cor_sipm_p0) + " + " + std::to_string(y_cor_sipm_p1)+"*y_dut[0] + "+std::to_string(y_cor_sipm_p2)+"*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_sipm_p3)+"*y_dut[0]*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_sipm_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0] "
+") : x_dut[0]>>h2_deltaT_sipm_afterTWXY_vs_x").c_str(),(cut_sipm+" && y_dut[0]>"+std::to_string(y_sipm_low)+" &&y_dut[0]<"+std::to_string(y_sipm_high)).c_str());


	h2_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetTitle("beam position X [mm]");
	h2_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_afterTWXY_vs_x->SetTitle("");
	h2_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_afterTWXY_vs_x->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_afterTWXY_vs_x = h2_deltaT_sipm_afterTWXY_vs_x->ProfileX(); //new ("p_deltaT_sipm_afterTWXY_vs_x","p_deltaT_sipm_afterTWXY_vs_x",72, x_low, x_high);
	p_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetTitle("beam position X [mm]");
	p_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_afterTWXY_vs_x->SetTitle("");
	
	p_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	//p_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetRangeUser(maxX_t_sipm-0.2, maxX_t_sipm+0.3);
       	p_deltaT_sipm_afterTWXY_vs_x->GetYaxis()->SetRangeUser(maxX_t_sipm_TWXYcorr-0.2, maxX_t_sipm_TWXYcorr+0.3);
       	p_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
        p_deltaT_sipm_afterTWXY_vs_x->SetMarkerStyle( 20 );
        p_deltaT_sipm_afterTWXY_vs_x->SetMarkerColor( 1 );
        p_deltaT_sipm_afterTWXY_vs_x->SetLineColor( 1 );
	p_deltaT_sipm_afterTWXY_vs_x->Draw();

	TF1 * tf1_pol4_afterTWXY_sipm_x = new TF1("tf1_pol4_afterTWXY_sipm_x","pol4", x_sipm_low-1, x_sipm_high+1.0);
	p_deltaT_sipm_afterTWXY_vs_x->Fit("tf1_pol4_afterTWXY_sipm_x","","",x_sipm_low_fit, x_sipm_high_fit);

	gPad->Modified();
	gPad->Update();
	
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_afterTWXY_vs_x->GetXaxis()->SetRangeUser(x_sipm_low, x_sipm_high);
	h2_deltaT_sipm_afterTWXY_vs_x->Draw();
	p_deltaT_sipm_afterTWXY_vs_x->SetMarkerColor( 4 );
        p_deltaT_sipm_afterTWXY_vs_x->SetLineColor( 4 );
	p_deltaT_sipm_afterTWXY_vs_x->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamX_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
	

	TH2F * h2_deltaT_sipm_afterTWXY_vs_y = new TH2F("h2_deltaT_sipm_afterTWXY_vs_y","h2_deltaT_sipm_afterTWXY_vs_y", 72, y_low, y_high, 100, maxX_t_sipm_TWXYcorr-0.2, maxX_t_sipm_TWXYcorr+0.3);
	//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"] - ("+std::to_string(amp_cor_p0) + " + " +std::to_string(amp_cor_p1)+"*amp["+ch1+"]) : y_dut[0]>>h2_deltaT_sipm_afterTWXY_vs_y").c_str(),cut_sipm.c_str());
	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_sipm_p0)+" + "+std::to_string(amp_cor_sipm_p1)+"*amp["+ch1+"] + "
+std::to_string(x_cor_sipm_p0)+ "+" +std::to_string(x_cor_sipm_p1)+"*x_dut[0] + "+std::to_string(x_cor_sipm_p2)+"*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_sipm_p3)+"*x_dut[0]*x_dut[0]*x_dut[0] + "+std::to_string(x_cor_sipm_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0] + "
+std::to_string(y_cor_sipm_p0) + " + " + std::to_string(y_cor_sipm_p1)+"*y_dut[0] + "+std::to_string(y_cor_sipm_p2)+"*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_sipm_p3)+"*y_dut[0]*y_dut[0]*y_dut[0] + "+std::to_string(y_cor_sipm_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0] "
+") : y_dut[0]>>h2_deltaT_sipm_afterTWXY_vs_y").c_str(),(cut_sipm+" && x_dut[0] > "+std::to_string(x_sipm_low)+" && x_dut[0]<"+std::to_string(x_sipm_high)).c_str());


	h2_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetTitle("beam position Y [mm]");
	h2_deltaT_sipm_afterTWXY_vs_y->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	h2_deltaT_sipm_afterTWXY_vs_y->SetTitle("");
	h2_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetTitleSize( axisTitleSizeX );
	h2_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	h2_deltaT_sipm_afterTWXY_vs_y->GetYaxis()->SetTitleSize( axisTitleSizeY );
	h2_deltaT_sipm_afterTWXY_vs_y->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
	
	h2_deltaT_sipm_afterTWXY_vs_y->Draw();
	
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_ch"+ch1+"_sipm.pdf").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_ch"+ch1+"_sipm.png").c_str());
	//myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_ch"+ch1+"_sipm.C").c_str());

	TProfile * p_deltaT_sipm_afterTWXY_vs_y = h2_deltaT_sipm_afterTWXY_vs_y->ProfileX(); //new ("p_deltaT_sipm_afterTWXY_vs_y","p_deltaT_sipm_afterTWXY_vs_y",72, y_low, y_high);
	p_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetTitle("beam position Y [mm]");
	p_deltaT_sipm_afterTWXY_vs_y->GetYaxis()->SetTitle(("#Delta T (ch"+ch1+", ch"+ch2+") / ns").c_str());
	p_deltaT_sipm_afterTWXY_vs_y->SetTitle("");
	
	p_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetTitleSize( axisTitleSizeX );
	p_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetTitleOffset( axisTitleOffsetX );
	p_deltaT_sipm_afterTWXY_vs_y->GetYaxis()->SetTitleSize( axisTitleSizeY );
	p_deltaT_sipm_afterTWXY_vs_y->GetYaxis()->SetTitleOffset( axisTitleOffsetY );
       	p_deltaT_sipm_afterTWXY_vs_y->GetYaxis()->SetRangeUser(maxX_t_sipm_TWXYcorr-0.2, maxX_t_sipm_TWXYcorr+0.3);
       	p_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
        p_deltaT_sipm_afterTWXY_vs_y->SetMarkerStyle( 20 );
        p_deltaT_sipm_afterTWXY_vs_y->SetMarkerColor( 1 );
        p_deltaT_sipm_afterTWXY_vs_y->SetLineColor( 1 );
	p_deltaT_sipm_afterTWXY_vs_y->Draw();

	TF1 * tf1_pol4_afterTWXY_sipm_y = new TF1("tf1_pol4_afterTWXY_sipm_y","pol4", y_sipm_low-1, y_sipm_high+1.0);
	p_deltaT_sipm_afterTWXY_vs_y->Fit("tf1_pol4_afterTWXY_sipm_y","","",y_sipm_low_fit, y_sipm_high_fit);
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_profile_ch"+ch1+"_sipm.pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_profile_ch"+ch1+"_sipm.png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_profile_ch"+ch1+"_sipm.C").c_str());

	h2_deltaT_sipm_afterTWXY_vs_y->GetXaxis()->SetRangeUser(y_sipm_low, y_sipm_high);
	h2_deltaT_sipm_afterTWXY_vs_y->Draw();
	p_deltaT_sipm_afterTWXY_vs_y->SetMarkerColor( 4 );
        p_deltaT_sipm_afterTWXY_vs_y->SetLineColor( 4 );
	p_deltaT_sipm_afterTWXY_vs_y->Draw("same");
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_scatter_and_profile_ch"+ch1+"_sipm.pdf").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_scatter_and_profile_ch"+ch1+"_sipm.png").c_str());
 	myC->SaveAs((plotDir+"/Run"+inFileName+"_deltaT_afterTWXY_vs_beamY_scatter_and_profile_ch"+ch1+"_sipm.C").c_str());
	...
	for(int ix = 1; ix<=9; ix++)
	{
		for(int iy=1;iy<=9;iy++)
		{
			...
			//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]>>h_deltaT_corr_x"+std::to_string(ix)+"_y"+std::to_string(iy)).c_str(),(cut_noPos+" && x_dut[0]>"+std::to_string(thisX_low)+" && x_dut[0]<"+std::to_string(thisX_high) +" && y_dut[0]>"+std::to_string(thisY_low)+" && y_dut[0]<"+std::to_string(thisY_high)).c_str());

			tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- ("+std::to_string(amp_cor_p0)+" + "+std::to_string(amp_cor_p1)+"*amp["+ch1+"])>>h_deltaT_corr_x"+std::to_string(ix)+"_y"+std::to_string(iy)).c_str(),(cut_noPos+" && x_dut[0]>"+std::to_string(thisX_low)+" && x_dut[0]<"+std::to_string(thisX_high) +" && y_dut[0]>"+std::to_string(thisY_low)+" && y_dut[0]<"+std::to_string(thisY_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_afterTW_2Dtimereso_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_afterTW_2Dtimereso_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_afterTW_2Dtimereso_ch"+ch1+".C").c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_afterTW_2DtimemeanT_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_afterTW_2DtimemeanT_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_xybins_afterTW_2DtimemeanT_ch"+ch1+".C").c_str());
	...
	for(int iamp = 1; iamp<=10; iamp++)
	{
		...
		//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]>>h_deltaT_corr_amp"+std::to_string(iamp)).c_str(),(cut+" && amp["+ch1+"]>"+std::to_string(thisAmp_low)+" && amp["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());

        	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- (" + std::to_string(x_cor_xyonly_p0)+" + "
+std::to_string(x_cor_xyonly_p1)+"*x_dut[0] + "+std::to_string(x_cor_xyonly_p2)+"*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_xyonly_p3)+"*x_dut[0]*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_xyonly_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0]+"
+std::to_string(y_cor_xyonly_p0)+" + "
+std::to_string(y_cor_xyonly_p1)+"*y_dut[0] + "+std::to_string(y_cor_xyonly_p2)+"*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_xyonly_p3)+"*y_dut[0]*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_xyonly_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0]"
+")>>h_deltaT_corr_amp"+std::to_string(iamp)).c_str(),(cut+" && amp["+ch1+"]>"+std::to_string(thisAmp_low)+"&& amp["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_ampbins_afterXY_timereso_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_ampbins_afterXY_timereso_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_ampbins_afterXY_timereso_ch"+ch1+".C").c_str());
	...
	float effamp_low_afterXY = 200.0;
	float effamp_high_afterXY = 1000.0;
	...
	for(int ieffamp = 1; ieffamp<=10; ieffamp++)
	{
		...
		//tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]>>h_deltaT_corr_effamp"+std::to_string(ieffamp)).c_str(),(cut+" && amp["+ch1+"]/baseline_RMS["+ch1+"]>"+std::to_string(thisAmp_low)+" && amp["+ch1+"]/baseline_RMS["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());

        	tree->Draw((time_ch1+"["+ch1+"]-"+time_ch2+"["+ch2+"]- (" + std::to_string(x_cor_xyonly_p0)+" + "
+std::to_string(x_cor_xyonly_p1)+"*x_dut[0] + "+std::to_string(x_cor_xyonly_p2)+"*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_xyonly_p3)+"*x_dut[0]*x_dut[0]*x_dut[0]+"+std::to_string(x_cor_xyonly_p4)+"*x_dut[0]*x_dut[0]*x_dut[0]*x_dut[0]+"
+std::to_string(y_cor_xyonly_p0)+" + "
+std::to_string(y_cor_xyonly_p1)+"*y_dut[0] + "+std::to_string(y_cor_xyonly_p2)+"*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_xyonly_p3)+"*y_dut[0]*y_dut[0]*y_dut[0]+"+std::to_string(y_cor_xyonly_p4)+"*y_dut[0]*y_dut[0]*y_dut[0]*y_dut[0]"
+")>>h_deltaT_corr_effamp"+std::to_string(ieffamp)).c_str(),(cut+" && amp["+ch1+"]/baseline_RMS["+ch1+"]>"+std::to_string(thisAmp_low)+" && amp["+ch1+"]/baseline_RMS["+ch1+"]<"+std::to_string(thisAmp_high)).c_str());
	...
	myC->SaveAs((plotDir+"/Run"+inFileName+"_effampbins_afterXY_timereso_ch"+ch1+".pdf").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_effampbins_afterXY_timereso_ch"+ch1+".png").c_str());
	myC->SaveAs((plotDir+"/Run"+inFileName+"_effampbins_afterXY_timereso_ch"+ch1+".C").c_str());
	...
	cout<<"[tot]:  [sigmaT_noCor_sipm=] "<<sigmaT_noCor_sipm<<"   [sigmaT_TWCor_sipm=] "<<sigmaT_TWCor_sipm<<"   [sigmaT_XYCor_sipm=] "<<sigmaT_XYCor_sipm<<"   [sigmaT_TWXYCor_sipm=] "<<sigmaT_TWXYCor_sipm<<"   [sigmaT_XYTWCor_sipm=] "<<sigmaT_XYTWCor_sipm<<endl;
