...
void pulses_blue_shiftnorm()
{
	TFile * f1 =  new TFile("~/LabData/Zhicai_Spring2018/data/1192_ana_withpulse.root");
	TTree * t1 = (TTree*)f1->Get("tree");

	TFile * f2 =  new TFile("~/LabData/Zhicai_Spring2018/data/1193_ana_withpulse.root");
	TTree * t2 = (TTree*)f2->Get("tree");

	TFile * f3 =  new TFile("~/LabData/Zhicai_Spring2018/data/1194_ana_withpulse.root");
	TTree * t3 = (TTree*)f3->Get("tree");

	float time_left = 40.5;
	float time_right = 44.5;
	...
	if(ch2Amp1 < 0.01) continue;
	if(ch2Amp2 < 0.01) continue;
	if(ch2Amp3 < 0.01) continue;
	...
	leg->AddEntry(gr1, "x = 2mm", "lp");
	leg->AddEntry(gr2, "x = 3mm", "lp");
	leg->AddEntry(gr3, "x = 4mm", "lp");
	leg->Draw();

	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_407nm_norm_side_xscan.pdf");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_407nm_norm_side_xscan.png");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_407nm_norm_side_xscan.C");
