...
void pulses_UV_shiftnorm()
{
	TFile * f1 =  new TFile("~/LabData/Zhicai_Spring2018/data/1235_ana_withpulse.root");
	TTree * t1 = (TTree*)f1->Get("tree");

	TFile * f2 =  new TFile("~/LabData/Zhicai_Spring2018/data/1236_ana_withpulse.root");
	TTree * t2 = (TTree*)f2->Get("tree");

	TFile * f3 =  new TFile("~/LabData/Zhicai_Spring2018/data/1237_ana_withpulse.root");
	...
	leg->AddEntry(gr1, "y = 4mm", "lp");
	leg->AddEntry(gr2, "y = 5mm", "lp");
	leg->AddEntry(gr3, "y = 6mm", "lp");
	leg->Draw();

	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nm_norm_side_yscan.pdf");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nm_norm_side_yscan.png");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nm_norm_side_yscan.C");
