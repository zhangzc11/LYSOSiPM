...
run = "combine_1216_1230_407nm_side_yscan"
#run = "combine_1231_1245_373nm_side_yscan"
...
for ix in range(0, nbins_X):
	...
	cut_this = cut + " && y > " + str(low_cut) + " && y <  " + str(high_cut)
	NEntries = tree.GetEntries(cut_this)

	#print cut_this
	print "timing resolution for y = "+str(x_this)
...
myC.SetGridy(1)
gr_deltaT_vs_y = ROOT.TGraphErrors(nbins_X, np.array(x_pos), np.array(deltaT), np.array(ex_pos), np.array(edeltaT))
gr_deltaT_vs_y.SetMarkerStyle( 20 )
gr_deltaT_vs_y.SetMarkerColor( ROOT.kBlack )
gr_deltaT_vs_y.SetLineWidth( 2 )
gr_deltaT_vs_y.SetLineColor( ROOT.kBlack ) 
gr_deltaT_vs_y.GetXaxis().SetTitle("y [mm]")
gr_deltaT_vs_y.GetYaxis().SetTitle("#Delta t (SiPM, laser) [ns]")
gr_deltaT_vs_y.SetTitle("")
gr_deltaT_vs_y.GetXaxis().SetTitleSize( axisTitleSizeX )
gr_deltaT_vs_y.GetXaxis().SetTitleOffset( axisTitleOffsetX )
gr_deltaT_vs_y.GetYaxis().SetTitleSize( axisTitleSizeY )
gr_deltaT_vs_y.GetYaxis().SetTitleOffset( axisTitleOffsetY )
gr_deltaT_vs_y.GetYaxis().SetRangeUser(41.6,42.6)
gr_deltaT_vs_y.Draw("AP")
myC.SaveAs(outputDir+run+"_deltaT_vs_y.pdf")
myC.SaveAs(outputDir+run+"_deltaT_vs_y.png")
myC.SaveAs(outputDir+run+"_deltaT_vs_y.C")

myC.SetGridy(0)

gr_ch2Amp_vs_y = ROOT.TGraphErrors(nbins_X, np.array(x_pos), np.array(ch2Amp), np.array(ex_pos), np.array(ech2Amp))
gr_ch2Amp_vs_y.SetMarkerStyle( 20 )
gr_ch2Amp_vs_y.SetMarkerColor( ROOT.kBlack )
gr_ch2Amp_vs_y.SetLineWidth( 2 )
gr_ch2Amp_vs_y.SetLineColor( ROOT.kBlack ) 
gr_ch2Amp_vs_y.GetXaxis().SetTitle("y [mm]")
gr_ch2Amp_vs_y.GetYaxis().SetTitle("amplitude [V]")
gr_ch2Amp_vs_y.SetTitle("")
gr_ch2Amp_vs_y.GetXaxis().SetTitleSize( axisTitleSizeX )
gr_ch2Amp_vs_y.GetXaxis().SetTitleOffset( axisTitleOffsetX )
gr_ch2Amp_vs_y.GetYaxis().SetTitleSize( axisTitleSizeY )
gr_ch2Amp_vs_y.GetYaxis().SetTitleOffset( axisTitleOffsetY )
gr_ch2Amp_vs_y.GetYaxis().SetRangeUser(0.0, max_amp)
gr_ch2Amp_vs_y.Draw("AP")
myC.SaveAs(outputDir+run+"_ch2Amp_vs_y.pdf")
myC.SaveAs(outputDir+run+"_ch2Amp_vs_y.png")
myC.SaveAs(outputDir+run+"_ch2Amp_vs_y.C")


gr_timeReso_vs_y = ROOT.TGraphErrors(nbins_X, np.array(x_pos), np.array(timeReso), np.array(ex_pos), np.array(etimeReso))
gr_timeReso_vs_y.SetMarkerStyle( 20 )
gr_timeReso_vs_y.SetMarkerColor( ROOT.kBlack )
gr_timeReso_vs_y.SetLineWidth( 2 )
gr_timeReso_vs_y.SetLineColor( ROOT.kBlack ) 
gr_timeReso_vs_y.GetXaxis().SetTitle("y [mm]")
gr_timeReso_vs_y.GetYaxis().SetTitle("#sigma_{t} [ns]")
gr_timeReso_vs_y.SetTitle("")
gr_timeReso_vs_y.GetXaxis().SetTitleSize( axisTitleSizeX )
gr_timeReso_vs_y.GetXaxis().SetTitleOffset( axisTitleOffsetX )
gr_timeReso_vs_y.GetYaxis().SetTitleSize( axisTitleSizeY )
gr_timeReso_vs_y.GetYaxis().SetTitleOffset( axisTitleOffsetY )
gr_timeReso_vs_y.GetYaxis().SetRangeUser(0.01, max_timeReso)
gr_timeReso_vs_y.Draw("AP")
myC.SaveAs(outputDir+run+"_timeReso_vs_y.pdf")
myC.SaveAs(outputDir+run+"_timeReso_vs_y.png")
myC.SaveAs(outputDir+run+"_timeReso_vs_y.C")


gr_ch2Risetime_vs_y = ROOT.TGraphErrors(nbins_X, np.array(x_pos), np.array(ch2Risetime), np.array(ex_pos), np.array(ech2Risetime))
gr_ch2Risetime_vs_y.SetMarkerStyle( 20 )
gr_ch2Risetime_vs_y.SetMarkerColor( ROOT.kBlack )
gr_ch2Risetime_vs_y.SetLineWidth( 2 )
gr_ch2Risetime_vs_y.SetLineColor( ROOT.kBlack ) 
gr_ch2Risetime_vs_y.GetXaxis().SetTitle("y [mm]")
gr_ch2Risetime_vs_y.GetYaxis().SetTitle("risetime [ns]")
gr_ch2Risetime_vs_y.SetTitle("")
gr_ch2Risetime_vs_y.GetXaxis().SetTitleSize( axisTitleSizeX )
gr_ch2Risetime_vs_y.GetXaxis().SetTitleOffset( axisTitleOffsetX )
gr_ch2Risetime_vs_y.GetYaxis().SetTitleSize( axisTitleSizeY )
gr_ch2Risetime_vs_y.GetYaxis().SetTitleOffset( axisTitleOffsetY )
gr_ch2Risetime_vs_y.GetYaxis().SetRangeUser(0.5,1.5)
gr_ch2Risetime_vs_y.Draw("AP")
myC.SaveAs(outputDir+run+"_ch2Risetime_vs_y.pdf")
myC.SaveAs(outputDir+run+"_ch2Risetime_vs_y.png")
myC.SaveAs(outputDir+run+"_ch2Risetime_vs_y.C")
