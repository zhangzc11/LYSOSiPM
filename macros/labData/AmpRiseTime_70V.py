...
for ix in range(0, nbins_X):
	...
	hist_deltaT = ROOT.TH1F("hist_deltaT_"+str(x_this),"hist_deltaT_"+str(x_this),N_deltaT,deltaT_mean-1.0,deltaT_mean+3.0)
	tree.Draw("t2gausroot-t1gausroot>>hist_deltaT_"+str(x_this),cut_this)	
...
gr_deltaT_vs_x.GetYaxis().SetRangeUser(41.5,43.5)
