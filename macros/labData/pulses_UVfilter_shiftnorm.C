...
void pulses_UVfilter_shiftnorm()
{
	TFile * f1 =  new TFile("~/LabData/Zhicai_Spring2018/data/1160_ana_withpulse.root");
	TTree * t1 = (TTree*)f1->Get("tree");

	TFile * f2 =  new TFile("~/LabData/Zhicai_Spring2018/data/1162_ana_withpulse.root");
	TTree * t2 = (TTree*)f2->Get("tree");

	TFile * f3 =  new TFile("~/LabData/Zhicai_Spring2018/data/1164_ana_withpulse.root");
	...
	if(ch2LinearTime601-t1gausroot1 > time_right || ch2LinearTime601-t1gausroot1 < time_left ) continue;
	if(ch2LinearTime602-t1gausroot2 > time_right || ch2LinearTime602-t1gausroot2 < time_left ) continue;
	if(ch2LinearTime603-t1gausroot3 > time_right || ch2LinearTime603-t1gausroot3 < time_left ) continue;
	...
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nmfilter_norm.pdf");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nmfilter_norm.png");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_373nmfilter_norm.C");
