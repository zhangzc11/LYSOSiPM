...
void pulses_blue_bias()
{
	TFile * f1 =  new TFile("~/LabData/Zhicai_Spring2018/data/1064.root");//65
	TTree * t1 = (TTree*)f1->Get("T");

	TFile * f2 =  new TFile("~/LabData/Zhicai_Spring2018/data/1066.root");//66
	TTree * t2 = (TTree*)f2->Get("T");

	TFile * f3 =  new TFile("~/LabData/Zhicai_Spring2018/data/1068.root");//67
	TTree * t3 = (TTree*)f3->Get("T");

	TFile * f4 =  new TFile("~/LabData/Zhicai_Spring2018/data/1070.root");//68
	TTree * t4 = (TTree*)f4->Get("T");

	TFile * f5 =  new TFile("~/LabData/Zhicai_Spring2018/data/1072.root");//69
	TTree * t5 = (TTree*)f5->Get("T");

	TFile * f6 =  new TFile("~/LabData/Zhicai_Spring2018/data/1074.root");//70
	TTree * t6 = (TTree*)f6->Get("T");

	TFile * f7 =  new TFile("~/LabData/Zhicai_Spring2018/data/1076.root");//71
	TTree * t7 = (TTree*)f7->Get("T");

	TFile * f8 =  new TFile("~/LabData/Zhicai_Spring2018/data/1078.root");//72
	...
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_407nm_bias.pdf");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_407nm_bias.png");
	myC->SaveAs("~/LabData/Zhicai_Spring2018/plots/pulses_407nm_bias.C");
