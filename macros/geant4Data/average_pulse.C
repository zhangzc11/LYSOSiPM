...
void average_pulse()
{
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/average_pulses_ref.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/average_pulses_ref.C");
