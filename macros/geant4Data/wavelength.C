...
void wavelength()
{
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/photonWaveLength_x"+x_s+".pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/photonWaveLength_x"+x_s+".png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/photonWaveLength_x"+x_s+".C");
