...
void tracks_x5()
{
	...
	TString x_s = "5";
	TFile *f = new TFile("/Users/zhicai/cernbox/TestBeam/geant4/ntuples/ntuple_x5_4mm_ps_withWL_newAbs_sptr.root");
	...
	TH2F * h2_allPhoTrackVertexR_sptr_vs_phoIndex = new TH2F("h2_allPhoTrackVertexR_sptr_vs_phoIndex","h2_allPhoTrackVertexR_sptr_vs_phoIndex", 200, 0, 200, 100, 4.0, 10.0);
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackVertexR_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackVertexR_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackVertexR_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.C");


	TH2F * h2_allPhoTrackLength_sptr_vs_phoIndex = new TH2F("h2_allPhoTrackLength_sptr_vs_phoIndex","h2_allPhoTrackLength_sptr_vs_phoIndex", 200, 0, 200, 100, 0, 100.0);
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackLength_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackLength_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackLength_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.C");
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTime_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTime_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTime_sptr_vs_phoIndex_x"+x_s+"_newAbs_sptr.C");
