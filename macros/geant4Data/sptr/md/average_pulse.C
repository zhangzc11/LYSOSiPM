...
void average_pulse()
{
	const double normNphoton0 = 103100.0;
	const double normNphoton2 = 68900.0;
	const double normNphoton5 = 81890.0;
	const int nDigi = 1024;

	TFile *f0 = new TFile("/Users/zhicai/cernbox/TestBeam/geant4/ntuples/ntuple_x0_4mm_md_ps_withWL_newAbs_sptr.root");
	TFile *f2 = new TFile("/Users/zhicai/cernbox/TestBeam/geant4/ntuples/ntuple_x2.root");
	TFile *f5 = new TFile("/Users/zhicai/cernbox/TestBeam/geant4/ntuples/ntuple_x5_4mm_md_ps_withWL_newAbs_sptr.root");
	...
	tree0->SetBranchAddress("amp1_sptr", &amp1);
	...
	tree5->SetBranchAddress("time1", &time1);
	tree5->SetBranchAddress("amp1_sptr", &amp1);
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/md_average_pulses_newAbs_sptr.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/md_average_pulses_newAbs_sptr.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/md_average_pulses_newAbs_sptr.C");
