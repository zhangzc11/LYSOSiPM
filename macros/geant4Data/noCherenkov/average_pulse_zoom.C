...
void average_pulse_zoom()
{
	...
	const double normNphoton2 = 81340.0;
	const int nDigi = 1024;

	TFile *f0 = new TFile("/Users/zhicai/cernbox/TestBeam/geant4/ntuples/ntuple_x0_4mm_ps_withWL.root");
	TFile *f2 = new TFile("/Users/zhicai/cernbox/TestBeam/geant4/ntuples/ntuple_x0_4mm_ps_withWL_NoCherenkov.root");
    ...
    leg->AddEntry(gr0, "w/ Cherenkov", "l");
    leg->AddEntry(gr2, "w/o Cherenkov", "l");
    leg->Draw();

	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/average_pulses_Cherenkov_zoom.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/average_pulses_Cherenkov_zoom.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/average_pulses_Cherenkov_zoom.C");
