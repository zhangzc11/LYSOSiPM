...
void tracks_x0()
{
	...
	TString x_s = "0";
	TFile *f = new TFile("/Users/zhicai/cernbox/TestBeam/geant4/ntuples/ntuple_x0_4mm_ps_withWL_NoCherenkov.root");
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackVertexR_vs_phoIndex_x"+x_s+"_NoCherenkov.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackVertexR_vs_phoIndex_x"+x_s+"_NoCherenkov.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackVertexR_vs_phoIndex_x"+x_s+"_NoCherenkov.C");
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackLength_vs_phoIndex_x"+x_s+"_NoCherenkov.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackLength_vs_phoIndex_x"+x_s+"_NoCherenkov.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTrackLength_vs_phoIndex_x"+x_s+"_NoCherenkov.C");
	...
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTime_vs_phoIndex_x"+x_s+"_NoCherenkov.pdf");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTime_vs_phoIndex_x"+x_s+"_NoCherenkov.png");
	myC->SaveAs("/Users/zhicai/cernbox/TestBeam/geant4/plots/tracks_allPhoTime_vs_phoIndex_x"+x_s+"_NoCherenkov.C");
